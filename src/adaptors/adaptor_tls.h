 ...
 *
 * Searches for the sslProfile in the passed in config and loads the details from that sslProfile.  Logs sslProfile
 * configuration failures to log_source at ERROR level. The returned qd_tls_domain_t instance may be used to create
 * multiple qd_tls_t instances.  The caller must call qd_tls_domain_decref() on the returned qd_tls_domain_t instance to
 * free it.
 *
...
/**
 * Constructor to create a new qd_tls_t object. This instance can be freed by calling qd_tls_free().
 *
