...
typedef struct qd_tls2_domain_t    qd_tls2_domain_t;
typedef struct qd_tls2_session_t   qd_tls2_session_t;
...
typedef struct qd_tcp_connection_t {
    ...
    char                       *reply_to;
    qd_tls2_session_t          *tls_session;   // tls session if configured for TLS
